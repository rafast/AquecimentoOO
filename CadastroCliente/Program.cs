...
namespace CadastroCliente
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (!entradaValida)
            {
                ...
                if (validaData(out data, inputData) && maiorIdade(data))
                {
                    ...
                    Console.WriteLine(maiorIdade(data));
            ...
            while (!entradaValida)
            {
                ...
                Console.WriteLine(validaRendaMensal("12,00"));
                Console.WriteLine(validaRendaMensal("12"));
                Console.WriteLine(validaRendaMensal("12.00"));
                Console.WriteLine(validaRenda(out renda, inputRendaMensal));
            ...
            while (!entradaValida)
            {
                ...
                {
                    cliente.Estado_civil = inputEstadoCivil.ToCharArray()[0];
                    entradaValida = true;
                }
                else
                {
        ...
        private static bool validaRendaMensal(string inputRendaMensal)
        {
            inputRendaMensal = inputRendaMensal.Replace('.', ',');
        ...
        private static bool validaDataNascimento(string inputData)
        {
            string padrao = "^(d{2})/(d{2})/(d{4})$";
            return Regex.IsMatch(inputData, padrao);
       }
